...
echo "[1/8] Checking for raw data..."
Rscript scripts/01_data_download.R

echo "[2/8] Creating Seurat object..."
Rscript scripts/02_create_seurat_obj.R

echo "[3/8] Generating pre-filter QC plots..."
Rscript scripts/03_qc_visualize.R

echo "[4/8] Filtering and normalizing cells..."
Rscript scripts/04_filter_cells.R

echo "[5/8] Running PCA and UMAP clustering..."
Rscript scripts/05_run_dim_reduction.R

echo "[6/8] Generating clustering plots..."
Rscript scripts/06_visualize_clusters.R

echo "[7/8] Finding cluster marker genes..."
Rscript scripts/07_find_markers.R

echo "[8/8] Annotating final cell types..."
