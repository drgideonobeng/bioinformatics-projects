...
# 5. Save the sheet of top genes
top_genes_path <- path(tables_dir, "02_top_cluster_markers_cheatsheet.csv")
...
message("Top genes cheat sheet saved to: ", top_genes_path)
