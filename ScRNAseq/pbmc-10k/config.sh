...
export RAW_DATA_URL="https://cf.10xgenomics.com/samples/cell-exp/3.0.0/pbmc_10k_v3/pbmc_10k_v3_filtered_feature_bc_matrix.tar.gz"
...
export UMAP_TITLE="Peripheral Blood Mononuclear Cells
"
